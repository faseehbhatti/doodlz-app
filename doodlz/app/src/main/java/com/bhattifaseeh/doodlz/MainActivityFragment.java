...
package com.bhattifaseeh.doodlz;
...
public class MainActivityFragment extends Fragment {
    ...
    private void confirmErase() {
        EraseImageDialogueFragment fragment = new EraseImageDialogueFragment();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.color:
                ColorDialogueFragment colorDialog = new ColorDialogueFragment();
                colorDialog.show(getFragmentManager(), "color dialog");
                return true; // consume the menu event
            case R.id.line_width:
                LineWidthDialogue widthDialog =
                        new LineWidthDialogue();
